...
const C = {
  ...
  alojamiento: { icon: '<i class="fa-solid fa-hotel"></i>', label: 'Alojamiento', color: '#f0567a', bg: '#fde8ee', hasStars: true, fields: [{ k: 'nombre', l: 'Nombre del hotel', t: 'text', ph: 'Hotel Luxe París', fw: true }, { k: 'checkin', l: 'Check-in', t: 'date' }, { k: 'checkout', l: 'Check-out', t: 'date' }, { k: 'habitacion', l: 'Tipo habitación', t: 'select', ph: 'Selecciona...', opts: ['Sencilla', 'Doble', 'Suite', 'Familiar'] }, { k: 'alimentacion', l: 'Alimentación', t: 'select', ph: 'Selecciona...', opts: ['Solo alojamiento', 'Desayuno incluido', 'Media pensión', 'Pensión completa', 'Todo incluido'] }, { k: 'phone', l: 'Teléfono', t: 'text', ph: '+1 234...' }, { k: 'website', l: 'Sitio Web', t: 'text', ph: 'https://...' }, { k: 'direccion', l: 'Dirección', t: 'text', ph: 'Avenida...', fw: true }, { k: 'reserva', l: 'Código reserva', t: 'text', ph: 'ALJ-12345' }, { k: 'precio', l: 'Precio', t: 'number', ph: '150' }, { k: 'notas', l: 'Notas', t: 'textarea', ph: 'Desayuno incluido...' }, { k: 'adjunto', l: 'Archivo adjunto (PDF/Img)', t: 'file-upload', fw: true }] },
  ...
  actividad: { icon: '<i class="fa-solid fa-bullseye"></i>', label: 'Actividad', color: '#f59e0b', bg: '#fef3c7', hasStars: true, fields: [{ k: 'nombre', l: 'Nombre actividad', t: 'text', ph: 'Cena con vista, Tour privado...', fw: true }, { k: 'direccion', l: 'Lugar (Google Maps)', t: 'text', ph: 'Torre Eiffel, Museo del Louvre...', fw: true }, { k: 'fecha', l: 'Fecha y hora', t: 'datetime-local' }, { k: 'duracion', l: 'Duración', t: 'select', opts: ['1h', '2h', '3h', '4h', 'Medio día', 'Día completo'] }, { k: 'phone', l: 'Teléfono', t: 'text', ph: '+1 234...' }, { k: 'website', l: 'Sitio Web', t: 'text', ph: 'https://...' }, { k: 'precio', l: 'Precio', t: 'number', ph: '25' }, { k: 'reserva', l: 'Código reserva', t: 'text', ph: 'ACT-12345' }, { k: 'descripcion', l: 'Descripción', t: 'textarea', ph: 'Descripción...' }, { k: 'notas', l: 'Notas', t: 'textarea', ph: 'Info adicional...' }, { k: 'adjunto', l: 'Archivo adjunto (PDF/Img)', t: 'file-upload', fw: true }] },
  comida: { icon: '<i class="fa-solid fa-utensils"></i>', label: 'Comida', color: '#f96b3a', bg: '#ffe8e0', hasStars: true, fields: [{ k: 'restaurante', l: 'Restaurante', t: 'text', ph: 'Le Jules Verne', fw: true }, { k: 'tipo', l: 'Tipo', t: 'select', opts: ['Desayuno', 'Almuerzo', 'Cena', 'Brunch', 'Snack'] }, { k: 'fecha', l: 'Fecha y hora', t: 'datetime-local' }, { k: 'phone', l: 'Teléfono', t: 'text', ph: '+1 234...' }, { k: 'website', l: 'Sitio Web', t: 'text', ph: 'https://...' }, { k: 'direccion', l: 'Dirección', t: 'text', ph: 'Avenida...', fw: true }, { k: 'estado_reserva', l: 'Reservación', t: 'select', opts: ['Sí, confirmada', 'Pendiente', 'No aplica'] }, { k: 'precio', l: 'Precio', t: 'number', ph: '80' }, { k: 'reserva', l: 'Código reserva', t: 'text', ph: 'RES-12345' }, { k: 'notas', l: 'Notas', t: 'textarea', ph: 'Menú degustación...' }, { k: 'adjunto', l: 'Archivo adjunto (PDF/Img)', t: 'file-upload', fw: true }] },
  tour: { icon: '<i class="fa-solid fa-map-location-dot"></i>', label: 'Tour', color: '#8b5cf6', bg: '#f5f3ff', fields: [{ k: 'nombre', l: 'Nombre del tour', t: 'text', ph: 'Tour Versalles' }, { k: 'operador', l: 'Operador', t: 'text', ph: 'Get Your Guide' }, { k: 'fecha', l: 'Fecha y hora', t: 'datetime-local' }, { k: 'duracion', l: 'Duración', t: 'select', opts: ['2h', '4h', 'Medio día', 'Día completo', '2 días', '3+ días'] }, { k: 'personas', l: 'No. personas', t: 'text', ph: '2' }, { k: 'precio', l: 'Precio', t: 'number', ph: '120' }, { k: 'reserva', l: 'Código reserva', t: 'text', ph: 'TOU-12345' }, { k: 'descripcion', l: 'Descripción', t: 'textarea', ph: 'Incluye entrada, guía...' }, { k: 'notas', l: 'Notas', t: 'textarea', ph: 'Info adicional...' }, { k: 'adjunto', l: 'Archivo adjunto (PDF/Img)', t: 'file-upload', fw: true }] },
  ...
  imagen: { icon: '<i class="fa-regular fa-image"></i>', label: 'Imagen', color: 'var(--primary-blue)', bg: '#e0f2fe', fields: [{ k: 'caption', l: 'Pie de foto', t: 'text', ph: 'Torre Eiffel al atardecer' }, { k: 'tamano', l: 'Tamaño', t: 'select', opts: ['Pequeño', 'Mediano', 'Grande', 'Completo'] }] },
  gif: { icon: '<i class="fa-solid fa-bolt"></i>', label: 'GIF', color: '#ce3df3', bg: '#f9f0ff', fields: [{ k: 'caption', l: 'Pie de GIF', t: 'text', ph: '¡Increíble!' }] },
...
function openModal(type, editIdx = null) {
  ...
  // Phase: Preserve place_id if it exists
  if (existData.place_id) {
    const hiddenPlaceId = document.createElement('input');
    hiddenPlaceId.type = 'hidden';
    hiddenPlaceId.dataset.key = 'place_id';
    hiddenPlaceId.value = existData.place_id;
    modalBody.appendChild(hiddenPlaceId);
  }
    ...
    if (googleTypes.includes(type) && window.google && window.google.maps && window.google.maps.places) {
      ...
      if (nameInp) {
        ...
        autocomplete.addListener('place_changed', () => {
          ...
          // Phase: Save place_id for later lazy-loading of photos
          // Preserve place_id in the data object for lazy loading in viewer
          if (editingItem && editingItem.data) {
              editingItem.data.place_id = place.place_id;
          }
          
          let hPlaceId = modalBody.querySelector('input[data-key="place_id"]');
          if (!hPlaceId) {
            hPlaceId = document.createElement('input');
            hPlaceId.type = 'hidden';
            hPlaceId.dataset.key = 'place_id';
            modalBody.appendChild(hPlaceId);
          }
          hPlaceId.value = place.place_id;

          // Fetch details excluding photos to avoid SKU costs
          fetch(`/api/places/details?place_id=${place.place_id}&include_photos=false`)
            .then(res => res.json())
            .then(data => {
              // We only care about details, no photos fetched here.
              console.log('Place details fetched (photos excluded)');
            })
...
function buildField(field, data) {
  ...
  if (field.t === 'textarea') { const ta = document.createElement('textarea'); ta.className = 'form-textarea'; ta.placeholder = field.ph || ''; ta.value = val; ta.dataset.key = field.k; fg.appendChild(ta) }
    ...
    // Store url & original name in hidden inputs
    ...
    const fileInp = document.createElement('input'); fileInp.type = 'file'; fileInp.accept = '.pdf,.doc,.docx,.jpg,.jpeg,.png,.webp'; fileInp.style.display = 'none';
    ...
    removeBtn.onclick = () => { hiddenUrl.value = ''; hiddenName.value = ''; statusText.innerHTML = '<i class="fa-solid fa-cloud-arrow-up"></i> Ningún archivo seleccionado'; removeBtn.style.display = 'none'; fileInp.value = ''; };
    ...
    fileInp.onchange = e => {
      ...
      statusText.innerHTML = '<i class="fa-solid fa-spinner fa-spin"></i> Subiendo...';
      btn.disabled = true;
      ...
      fetch(`/trips/${tripId}/upload-attachment`, {
        ...
        .then(res => {
          ...
          if (res.success) {
            ...
            hiddenName.value = res.original_name;
        ...
        .catch(err => {
          btn.disabled = false;
          statusText.innerHTML = '<i class="fa-solid fa-circle-exclamation" style="color:#ef4444"></i> Error de conexión';
          console.error(err);
        });
    };
