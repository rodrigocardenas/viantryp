...
return [
    'codes' => [
        ...
        'viajero_pro'  => env('PLAN_CODE_VIAJERO_PRO', env('PLAN_CODE_AVANZADO', 'V7K2-MQ9X-E4NR,A3PH-XW8T-Z6LJ')),
        'viajero pro'  => env('PLAN_CODE_VIAJERO_PRO', env('PLAN_CODE_AVANZADO', 'V7K2-MQ9X-E4NR,A3PH-XW8T-Z6LJ')),
        'avanzado'     => env('PLAN_CODE_VIAJERO_PRO', env('PLAN_CODE_AVANZADO', 'V7K2-MQ9X-E4NR,A3PH-XW8T-Z6LJ')),
