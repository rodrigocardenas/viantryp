...
Route::middleware('auth')->group(function () {
    ...
    Route::post('trips/{trip}/ai/chat-agent', [TripAiController::class, 'handleChat'])->name('trips.ai.chat')->middleware('throttle:5,1');
    ...
    Route::get('/subscription/usage', [\App\Http\Controllers\ProfileController::class, 'getUsage'])->name('subscription.usage');
    ...
    Route::post('/profile/plan/paddle-sync', [\App\Http\Controllers\ProfileController::class, 'syncPaddlePlan'])->name('profile.plan.paddle-sync');
