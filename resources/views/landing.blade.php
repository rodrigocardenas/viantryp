...
<head>
  ...
  {{-- Preload Onboarding Images for Instant Clean Rendering --}}
  <link rel="preload" as="image" href="{{ asset('images/onboarding/app1.png') }}" fetchpriority="high">
  <link rel="preload" as="image" href="{{ asset('images/onboarding/app2.png') }}">
  <link rel="preload" as="image" href="{{ asset('images/onboarding/app3.png') }}">
  <link rel="preload" as="image" href="{{ asset('images/onboarding/app4.png') }}">
  {{-- PWA --}}
