...
@section('content')
  ...
  <div class="page-hero" style="padding:4rem 2rem 3.5rem;">
    ...
    <p class="page-hero-sub">Estos términos rigen el uso de Viantryp por parte de cualquier persona — viajero individual,
      grupo, familia o empresa.</p>
  </div>
  ...
  <div style="background:var(--off-white); border-bottom:1px solid var(--mid-gray);">
    <div class="container">
      <div style="display:flex; gap:0.5rem; padding:0.75rem 0; flex-wrap:wrap;">
        <a href="{{ route('terms') }}"
          style="padding:0.4rem 1rem; border-radius:100px; background:var(--navy); color:white; font-size:0.82rem; font-weight:600; text-decoration:none;">Términos
          de uso</a>
        <a href="{{ route('privacy') }}"
          style="padding:0.4rem 1rem; border-radius:100px; color:var(--text-soft); font-size:0.82rem; font-weight:500; text-decoration:none; transition:color 0.2s;"
          onmouseover="this.style.color='var(--navy)'" onmouseout="this.style.color='var(--text-soft)'">Privacidad</a>
        <a href="{{ route('gdpr') }}"
          style="padding:0.4rem 1rem; border-radius:100px; color:var(--text-soft); font-size:0.82rem; font-weight:500; text-decoration:none; transition:color 0.2s;"
          onmouseover="this.style.color='var(--navy)'" onmouseout="this.style.color='var(--text-soft)'">RGPD</a>
        <a href="{{ route('security') }}"
          style="padding:0.4rem 1rem; border-radius:100px; color:var(--text-soft); font-size:0.82rem; font-weight:500; text-decoration:none; transition:color 0.2s;"
          onmouseover="this.style.color='var(--navy)'" onmouseout="this.style.color='var(--text-soft)'">Seguridad</a>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="legal-layout">
        ...
        <div class="legal-sidebar">
          <div
            style="font-size:0.72rem; font-weight:700; letter-spacing:0.1em; text-transform:uppercase; color:var(--text-muted); margin-bottom:1rem;">
            Contenido</div>
