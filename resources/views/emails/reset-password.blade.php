  ...
  <div class="wrap">
    ...
    <div class="topbar">
      <a href="{{ config('app.url') }}" style="display:block; text-decoration:none;">
        <img src="{{ config('app.url') }}/images/logo-viantryp.png" alt="Viantryp"
    ...
    <div class="body">
      ...
      <div class="safety">
        ...
        <span class="safety-text">
          <b>¿No solicitaste este cambio?</b> Ignora este correo — tu contraseña actual seguirá siendo la misma y tu
          cuenta está segura.
        </span>
      </div>
    ...
    <div class="footer">
      <img src="{{ config('app.url') }}/images/logo-viantryp.png" alt="Viantryp"
        style="height: 18px; width: auto; display: inline-block; opacity: 0.8; margin-bottom: 10px;">
      <p class="footer-copy">
        Este correo fue enviado a {{ $user_email }} · © {{ date('Y') }} Viantryp<br>
        Si tienes problemas, escríbenos a <a href="mailto:hola@viantryp.com"
          style="color:#1a9a8a;text-decoration:none;">hola@viantryp.com</a>
      </p>
    </div>
