...
class SecurityHeaders
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $csp = implode('; ', [
            ...
            "connect-src 'self' https://maps.googleapis.com https://api.unsplash.com https://api.giphy.com https://nominatim.openstreetmap.org https://photon.komoot.io https://*.basemaps.cartocdn.com https://*.paddle.com https://sandbox-api.paddle.com https://buy.paddle.com https://api.paddle.com",
